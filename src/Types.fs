...
module Types =
  ...
  type WorkspaceSymbolClientCapabilities =
    { /// Symbol request supports dynamic registration.
      ...
      TagSupport: TagSupportCapabilities option }
  ...
  type FileOperationsClientCapabilties =
  ...
  type WorkspaceClientCapabilities =
    { /// The client supports applying batch edits to the workspace by supporting
      ...
      FileOperations: FileOperationsClientCapabilties option
  ...
  type TextDocumentClientCapabilities =
    { Synchronization: SynchronizationCapabilities option
      ...
      CallHeirarchy: DynamicCapabilities option
      ...
      TypeHeirarchy: DynamicCapabilities option
  ...
  type StaleRequestSupportCapabilities =
  ...
  type RegularExpressionsClientCapabilities = { Engine: string; Version: string option }
  ...
  type GeneralClientCapabilties =
    { /// Client capability that signals how the client
      /// handles stale requests (e.g. a request
      /// for which the client will not process the response
      /// anymore since the information is outdated).
      StaleRequestSupport: StaleRequestSupportCapabilities option
  ...
  type ClientCapabilities =
    { /// Workspace specific client capabilities.
      ...
      General: GeneralClientCapabilties option
